...
public abstract class ClassUtils {
	 ...
	 * 以基本类型的包装类的class对象为键，对应的基本类型class对象为值的一个MAP
	 */
	 ...
	 * 以基本类型的class为键，对应的包装类的class对象为值的MAP
	 */
	 ...
	 * 以基本类型的名称为键，基本类型的class对象为值的MAP
	 */
	private static final Map<String, Class<?>> primitiveTypeNameMap = new HashMap<String, Class<?>>(32);

	/**
	 * Map with common "java.lang" class name as key and corresponding Class as value.
	 * 以常用的"java.lang" 类名为键，对应的class对象为值的MAP
	 ...
	 * * 替换Class.forName() 方法，让此方法同时也能返回基本类型（例如int）和数组的类对象
	 * Furthermore, it is also capable of resolving inner class names in Java source
	 * style (e.g. "java.lang.Thread.State" instead of "java.lang.Thread$State").
	 * 而且这个方法同时也可以分解并获取以java资源格式命名的内部类(例如 "java.lang.Thread.State" 而不是 " 
